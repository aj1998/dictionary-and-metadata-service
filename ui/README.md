...
| `components/DefinitionModal.test.ts` | `getBlockBorderClass`, `formatRefSourceLabel`, `parseMarkdownSegments` (including null-input guards), `pickRefsToShow`, `pickHiddenRefs` |
