...
| `api/navigation.ts` | core-service navigation domain | `/api/navigation` | `getNavLanding`, `expandNode`, `getPreview`, `getTopicNeighbors`, `getTopicAncestors`, `getTopicRelated`, `getTopicMentionedKeywords` |
