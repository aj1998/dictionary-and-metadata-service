...
Storage: small YAML files under `parser_configs/shastra_layouts/<family>/<natural_key>.yaml`, version-controlled like [`parser_configs/jainkosh.yaml`](../../../parser_configs/jainkosh.yaml). The registry table parallels `parser_configs` from [`02_data_model_postgres.md`](../02_data_model_postgres.md).
